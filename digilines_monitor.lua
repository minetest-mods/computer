...
minetest.register_node("computer:dl_monitor", {
	...
	tiles = {"computer_monitor_tdl.png","computer_monitor_btdl.png","computer_monitor_f_dl.png","computer_monitor_b.png","computer_monitor_r.png","computer_monitor_l.png"},
	--inventory_image =
	paramtype = "light",
	light_source = 8,
	paramtype2 = "facedir",
	...
	node_box = {
		type = "fixed",
		fixed = {
			{-0.5, -0.4375, -0.5, -0.4375, 0.4375, 0.5}, -- NodeBox1
			{-0.5, -0.5, -0.25, -0.25, -0.466981, 0.25}, -- NodeBox2
			{-0.5, -0.5, -0.125, -0.459906, 0.0283019, 0.125}, -- NodeBox3
			{0.125, -0.5, -0.4375, 0.4375, -0.4375, 0.4375}, -- NodeBox5 
			},
		},
	selection_box = {
		type = "fixed",
		fixed = {
			{-0.5, -0.3125, -0.5, -0.4375, 0.4375, 0.5}, -- NodeBox1
			{-0.5, -0.5, -0.25, -0.25, -0.466981, 0.25}, -- NodeBox2
			{-0.5, -0.5, -0.125, -0.459906, 0.0283019, 0.125}, -- NodeBox3
			{0.125, -0.5, -0.4375, 0.4375, -0.4375, 0.4375}, -- NodeBox5 
			},
